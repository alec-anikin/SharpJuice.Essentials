...
namespace SharpJuice.Essentials.Tests
{
    public class MaybeTests
    {
        ...
        [Fact]
        public void BindingEmptyWithThrowException_NotThrows()
        {
            var maybe = new Maybe<int>();
            Action act = () => maybe.Bind(i => throw new InvalidOperationException());

            act.Should().NotThrow();
        }

        [Fact]
        public void BindingTaskMaybeWithThrowException_NotThrows()
        {
            var maybe = new Maybe<Task<int>>();
            Func<Task> act = () => maybe.Bind(i => throw new InvalidOperationException());
